...
namespace Samples
{
    public class Sample
    {
        ...
        private static void testIBMethods(EWrapperImpl wrapper)
        {
            ...
            //wrapper.ClientSocket.reqMktData(1003, ContractSamples.getEuropeanStock(), "", false, null);
            wrapper.ClientSocket.reqMktData(1003, ContractSamples.GetUSStock(), "", false, GetFakeParameters(3));
            Console.ReadKey();
            Thread.Sleep(2000);
