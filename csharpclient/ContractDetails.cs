    ...
    public class ContractDetails : TWSLib.IContractDetails
    {
       ...
       */
        ...
        */
        ...
        /*** For TagValue ***/
        public string TVSecIdListTag
        {
            get
            {
                return secIdList.Select(t => t.Tag).Aggregate((tagstring, next) => string.Concat(tagstring, ",", next));
            }
        }

        /*** For TagValue ***/
        public string TVSecIdListValue
        {
            get
            {
                return secIdList.Select(t => t.Value).Aggregate((valuestring, next) => string.Concat(valuestring, ",", next));
            }
        }
        #endregion
