...
namespace IBApi
{
    ...
    public class Contract : TWSLib.IContract
    {
        ...
        */
         ...
         * @sa ComboLeg
         */
        public virtual List<ComboLeg> ComboLegs
        {
         ...
         * @sa UnderComp
         */
        public virtual UnderComp UnderComp
        {
        ...
        object TWSLib.IContract.comboLegs
        {
            ...
            get
            { return new TWSLib.ComboLegList(comboLegs); }

            [param: MarshalAs(UnmanagedType.IDispatch)]
            set
            { comboLegs = value is TWSLib.ComboLegList ? (value as TWSLib.ComboLegList).Ocl : null; }
        }
